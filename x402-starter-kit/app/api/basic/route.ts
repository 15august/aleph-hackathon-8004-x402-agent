...
export async function GET(request: Request) {
  ...
  console.log("payTo:", process.env.MERCHANT_WALLET_ADDRESS);
  console.log("serverWallet:", process.env.THIRDWEB_SERVER_WALLET_ADDRESS);
  console.log("hasPaymentData:", !!paymentData);
